...
function StatCard({ icon: Icon, label, value, hint, tone = "default" }) {
  ...
  return (
    <div className="rounded-[24px] border border-white/70 bg-white/90 p-4 shadow-[0_16px_44px_rgba(15,23,42,0.06)] backdrop-blur-xl">
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-400">
            {label}
          </div>
          <div className="mt-2 text-base font-semibold text-slate-900 sm:text-lg">{value}</div>
          {hint ? <p className="mt-2 text-sm leading-5 text-slate-500">{hint}</p> : null}
        </div>
        <div className={`flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br ${toneClass}`}>
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <div className="rounded-[28px] border border-white/70 bg-white/90 p-4 shadow-[0_18px_60px_rgba(15,23,42,0.06)] backdrop-blur-xl sm:p-5">
          <div className="flex flex-col gap-4 border-b border-slate-200/80 pb-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              {isAdminPreview ? (
                <div className="rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-amber-700">
        ...
        {activeTab === "mensajes" ? (
          <div className="rounded-[26px] border border-white/70 bg-white/92 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.05)] sm:p-6">
            ...
            {mensajes.length === 0 ? (
              <div className="mt-6 rounded-[24px] border border-dashed border-slate-300 bg-slate-50 p-6 text-center sm:p-7">
                <Mail className="mx-auto h-8 w-8 text-slate-300" />
                <p className="mt-3 text-base font-semibold text-slate-700">Aún no tienes mensajes aprobados por tu médico.</p>
        ...
        <div className="grid gap-4">
          <div className="rounded-[26px] border border-white/70 bg-white/90 p-5 shadow-[0_18px_54px_rgba(15,23,42,0.05)]">
            <div className="flex items-center gap-3">
